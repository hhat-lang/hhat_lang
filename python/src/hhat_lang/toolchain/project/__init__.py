...
# paths
MAIN_PATH = Path(SOURCE_FOLDER_NAME) / MAIN_DOC_FILE_NAME
IMPORTS_PATH = Path(SOURCE_FOLDER_NAME) / IMPORTS_FOLDER_NAME
SOURCE_TYPES_PATH = Path(SOURCE_FOLDER_NAME) / TYPES_FOLDER_NAME
DOCS_TYPES_PATH = Path(DOCS_FOLDER_NAME) / TYPES_FOLDER_NAME
