...
PROGRAM_DICT_EXPRS = dict(
    ...
    FUNC_MAIN_PARAMS_BODY_MEASURE_EXPR=(SYMBOL_KEY, TYPE_KEY, PARAMS_KEY, BODY_KEY, MEASURE_KEY),
    FUNC_MAIN_BODY_MEASURE_EXPR=(SYMBOL_KEY, TYPE_KEY, BODY_KEY, MEASURE_KEY),
    ...
    FUNC_MAIN_PARAMS_MEASURE_EXPR=(SYMBOL_KEY, TYPE_KEY, PARAMS_KEY, MEASURE_KEY),
    FUNC_MAIN_MEASURE_EXPR=(SYMBOL_KEY, TYPE_KEY, MEASURE_KEY),
